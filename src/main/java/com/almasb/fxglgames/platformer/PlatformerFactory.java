...
public class PlatformerFactory implements EntityFactory {
    ...
    public Entity newBackground(SpawnData data) {
        return entityBuilder()
                .view(new ScrollingBackgroundView(texture("background/marioAchtergrond.png").getImage(), getAppWidth(), getAppHeight()))
                .zIndex(-1)
    ...
    public Entity newPlayer(SpawnData data) {
        ...
        return entityBuilder(data)
                ...
                .with(new CollidableComponent(true))
                .with(new IrremovableComponent())
                .with(new com.almasb.fxglgames.platformer.PlayerComponent())
                .build();
    }
